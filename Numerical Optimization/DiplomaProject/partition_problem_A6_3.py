...
if __name__ == '__main__':
    ...
    density_vector = [lambda x, y: 1.0, lambda x, y: 1.0]
    ...
    psi_initial = np.array([5.6, 7.8, 4.3, 8.9, 1.2, 300.0, 760.0, 0.00001, 110.0])
    ...
    figsize = (15.0, 7.5)
    grid_dot_num_x_plotting, grid_dot_num_y_plotting = 1200, 4000
    ...
    r_alg_results = nlopt.r_algorithm_interior_point_2_cooperative(
        ...
        lambda k: 2000 * 0.85 ** k, lambda k: 2000 * 0.85 ** k, target_1='max', target_2='min', args_1=args, args_2=args,
        form='H', calc_epsilon_x=1e-4, calc_epsilon_grad=1e-4, r_epsilon=1600.0, iter_lim=100, print_iter_index=True,
