...
tau = np.array([
    [3.0, 4.751, 0.811, 2.0048, 3.0, 0.2081, 4.3896, 3.0, 3.0],
    [4.221, 0.6176, 12.0, 3.3155, 10.525, 17.1092, 10.6873, 16.8376, 14.7376]
])

psi = np.array([0.0009, 0.0, 0.0, 0.0, 0.0007, 0.0, 0.0, 0.0023, 0.0015])
